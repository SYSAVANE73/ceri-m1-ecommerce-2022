...
export class GetDataService {
  ...
  getAlbums() : Observable<Object> {
    ...
    return Observable.create((observer: Subscriber<Object>) => {
      this._http.get<any>('https://redpanda-frontend-mwjszocsqa-ew.a.run.app/album/',{})
      .subscribe(
  ...
  getDetails(id : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/album/' + id;
  ...
  getAlbum(id : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/getAlbum/' + id;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          album = data;
  ...
  getArtistes() : Observable<Object> {
    ...
    return Observable.create((observer: Subscriber<Object>) => {
      this._http.get<any>('https://redpanda-frontend-mwjszocsqa-ew.a.run.app/',{})
      .subscribe(
        data => { // succes de l’observable httpClient
          artistes = data;
  ...
  getPanier(id : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/panier/' + id;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          panier = data;
  ...
  insertPanier(id_user : number, id_album : number, montant : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/insertPanier/' + id_user + "/" + id_album + "/" + montant + "/" + quantite;
      console.log(url);
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
  ...
  deletePanier(id_user : number, id_album : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/supprimer_panier/' + id_user + "_" + id_album;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          msg = data;
  ...
  getFavoris(id : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/favoris/' + id;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          favoris = data;
  ...
  insertFavoris(id_album : number, id_user : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/insertFavoris/' + id_album + "/" + id_user;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          msg = data;
  ...
  deleteFavoris(id_album : number, id_user : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/supprimer_favoris/' + id_album + "_" + id_user;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          msg = data;
  ...
  insertHistorique(id_user : number, id_album : string, albums: string, quantite: string, montant: number, date: string ) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/paiement/' + id_user +'/'+id_album+ '/'+ albums+'/'+quantite+'/'+montant+'/'+date;
      console.log(url);
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
  ...
  getHistorique(id_user : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/historique_user/' + id_user ;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          msg = data;
  ...
  updateStock(id_album : number, quantite: number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/modifier_stock_album/' + id_album +'_'+quantite ;
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          msg = data;
  ...
  insertAlbum(titre : string, genre : string, annee : string, idartiste : number, nomartiste : string, prix : number, photo : string, stock : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/insert_album/' + titre + "_" + genre + "_" + annee + "_" + idartiste + "_" + nomartiste + "_" + prix + "_" + photo + "_" + stock;
      //console.log(url);
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
  ...
  insertArtiste(nom : string, prenom : string, nom_artiste : string) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/insert_artiste/' + nom + "/" + prenom + "/" + nom_artiste;
      console.log(url);
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
  ...
  insertChanson(titre : string, id_album : number, duree : number) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/insert_chanson/' + titre + "_" + id_album + "_" + duree;
      console.log(url);
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
   ...
   getHistoriquetot() : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/historique/';
      this._http.get<any>(url,{})
      .subscribe(
        data => { // succes de l’observable httpClient
          msg = data;
  ...
  updateStautCom(id : number, statut : string) : Observable<any> {
    ...
    return Observable.create((observer: Subscriber<any>) => {
      ...
      let url = 'https://redpanda-frontend-mwjszocsqa-ew.a.run.app/update_statut/' + id + "/" + statut ;
